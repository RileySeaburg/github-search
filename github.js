...
var Github = /** @class */ (function () {
    ...
    Github.prototype.getUser = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var profileResponse, repoResponse, profile, repos;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("https://api.github.com/users/" + user + "?client_id=" + this.client_id + "&client_secret=" + this.client_secret)];
                    case 1:
