...
(this['webpackJsonpgithub-finder-react'] =
	this['webpackJsonpgithub-finder-react'] || []).push([
	[0],
	{
		33: function (e, A) {
			e.exports =
		...
		63: function (e, A, t) {
				...
				C = function (e) {
					...
					return n.a.createElement(
						...
						n.a.createElement(
							'h1',
							null,
							n.a.createElement('i', { className: A }),
							' ',
							t,
						),
						n.a.createElement(
							...
							n.a.createElement(
								'li',
								null,
								n.a.createElement(u.b, { to: '/' }, 'Home'),
							),
							n.a.createElement(
								'li',
								null,
								n.a.createElement(u.b, { to: '/about' }, 'About'),
							),
						),
					);
				};
			C.defaultProps = { title: 'Github Finder', icon: 'fab fa-github' };
			var m = C,
				Q = function (e) {
					var A = e.user,
						t = A.login,
				...
				G = function (e) {
					...
					return e.loading
						...
						: n.a.createElement(
								...
								{ style: p },
								A.map(function (e) {
									return n.a.createElement(Q, { key: e.id, user: e });
								}),
						  );
				},
				U = function (e) {
					...
					return n.a.createElement(
						...
						n.a.createElement(
							'h3',
							null,
							n.a.createElement('a', { href: A.html_url }, A.name),
						),
					);
				},
				d = function (e) {
					return e.repos.map(function (e) {
						return n.a.createElement(U, { repo: e, key: e.id });
					});
				},
				D = (function (e) {
					Object(i.a)(t, e);
										...
										: n.a.createElement(
												...
												n.a.createElement(
													...
													n.a.createElement(
														...
														n.a.createElement('h1', null, A),
														n.a.createElement('p', null, 'Location: ', r),
													),
													n.a.createElement(
														'div',
														{ className: '' },
														c &&
															n.a.createElement(
																a.Fragment,
																null,
																n.a.createElement('h3', null, 'Bio'),
																n.a.createElement('p', null, c),
															),
														n.a.createElement(
															'a',
															{ className: 'btn btn-dark my-1', href: s },
				...
				Y = (function (e) {
					...
					function t() {
						...
						for (var a = arguments.length, n = new Array(a), r = 0; r < a; r++)
							n[r] = arguments[r];
						return (
							((e = A.call.apply(A, [this].concat(n))).state = { text: '' }),
							(e.onSubmit = function (A) {
								A.preventDefault(),
									'' === e.state.text
										? e.props.setAlert('Please enter something', 'light')
										: (e.props.searchUsers(e.state.text),
										  e.setState({ text: '' }));
							}),
							(e.onChange = function (A) {
								return e.setState({ text: A.target.value });
							}),
							e
						);
					}
								...
								value: function () {
									...
									return n.a.createElement(
										...
										A &&
											n.a.createElement(
												'button',
												{ className: 'btn btn-light btn-block', onClick: t },
												'Clear',
											),
									);
								},
				...
				S = function (e) {
					...
					return (
						...
						n.a.createElement(
							'div',
							{ className: 'alert alert-'.concat(A.type) },
							n.a.createElement('i', { className: 'fas fa-info-circle' }),
							' ',
							A.msg,
						)
					);
				...
				f = function () {
					return n.a.createElement(
						'div',
						null,
						n.a.createElement('h1', null, 'About This App'),
						n.a.createElement('p', null, 'App to search github users'),
						n.a.createElement('p', null, 'v1.0.0'),
					);
				},
				b = t(16),
				k = t.n(b),
					...
					(function (e) {
						...
						function t() {
							...
							for (
								...
								n[r] = arguments[r];
							return (
								((e = A.call.apply(A, [this].concat(n))).state = {
									users: [],
									user: {},
									repos: [],
									loading: !1,
															...
															return (
																...
																k.a.get(
																	'https://api.github.com/search/users?q='
																		.concat(t, '&client_id=')
																		.concat(
																			'61d242913ed8a4de08a9',
																			'&clien_secret=',
																		)
																		.concat(
																			'86ccae5a3e69065b11851f98e0070831832136ad',
																		),
																)
															);
														case 3:
											...
											return E.a.wrap(function (A) {
												for (;;)
													switch ((A.prev = A.next)) {
														...
														case 3:
															(a = A.sent),
																e.setState({ user: a.data, loading: !1 });
														case 5:
														case 'end':
															return A.stop();
													}
											...
											return E.a.wrap(function (A) {
												for (;;)
													switch ((A.prev = A.next)) {
														...
														case 3:
															(a = A.sent),
																e.setState({ repos: a.data, loading: !1 });
														case 5:
														case 'end':
															return A.stop();
													}
								...
								(e.clearUsers = function () {
									return e.setState({ users: [], loading: !1 });
								}),
								(e.setAlert = function (A, t) {
									e.setState({ alert: { msg: A, type: t } }),
										setTimeout(function () {
											return e.setState({ alert: null });
										}, 1e3);
								}),
								e
							);
										...
										return n.a.createElement(
											...
											n.a.createElement(
												...
												n.a.createElement(
													'div',
													{ className: 'container' },
													n.a.createElement(S, { alert: this.state.alert }),
													n.a.createElement(
														h.c,
														null,
			...
			c.a.render(
				n.a.createElement(n.a.StrictMode, null, n.a.createElement(R, null)),
...
//# sourceMappingURL=main.ac4d878e.chunk.js.map
