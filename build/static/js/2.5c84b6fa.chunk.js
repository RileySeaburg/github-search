/**
 * /*! For license information please see 2.5c84b6fa.chunk.js.LICENSE.txt
 *
 * @format
 */
...
(this['webpackJsonpgithub-finder-react'] =
	...
	[
							...
							return (
								i.a.Children.forEach(e.props.children, function (e) {
									if (null == r && i.a.isValidElement(e)) {
										...
										r = a
											? T(o.pathname, Object(v.a)({}, e.props, { path: a }))
											: t.match;
									}
								}),
								r
		...
		function (e, t, n) {
							...
							i
								? (er &&
										...
										(ar || i !== nr.compositionStart
											...
											: ((Dn = 'value' in (In = r) ? In.value : In.textContent),
											  (ar = !0))),
			...
			function Wo(e) {
				return null === Ao ? ((Ao = [e]), (Fo = Eo(_o, qo))) : Ao.push(e), jo;
			}
			function Qo() {
				if (null !== Fo) {
					var e = Fo;
			...
			function qo() {
				if (!Io && null !== Ao) {
					...
					try {
						...
						throw (null !== Ao && (Ao = Ao.slice(e + 1)), Eo(_o, Qo), n);
					} finally {
						Io = !1;
					}
				}
			...
			function qa(e, t, n) {
				var r = t.pendingProps,
					o = r.revealOrder,
					i = r.tail;
				if ((Ra(e, t, r.children, n), 0 !== (2 & (r = Ai.current))))
								...
								: ((n = null !== r),
								  ...
								  n &&
										...
										0 !== (1 & Ai.current)
											? Pl === wl && (Pl = xl)
											: ((Pl !== wl && Pl !== xl) || (Pl = kl),
											  0 !== Ll && null !== Tl && (ju(Tl, Cl), zu(Tl, Ll)))),
								  (n || r) && (t.effectTag |= 4),
								  null)
						);
					case 4:
			...
			function Yl(e, t) {
				...
				return (
					null !== o && (Tl === o && (au(t), Pl === kl && ju(o, Cl)), zu(o, t)),
					o
				);
			}
			function Xl(e) {
			...
			function Jl(e, t) {
				if (((Wl = 0), t)) return Mu(e, (t = Ql())), Gl(e), null;
				var n = Xl(e);
				if (0 !== n) {
			...
			function bu(e, t, n) {
				...
				null !== r && r.delete(t),
					Tl === e && Cl === n
						? Pl === kl || (Pl === xl && 1073741823 === Ol && Uo() - zl < 500)
							? nu(e, Cl)
							: (jl = !0)
						: Lu(e, n) &&
						...
						u > l
							? ((e.sortIndex = u),
							  ...
							  null === C(O) &&
									e === C(N) &&
									(A ? i() : (A = !0), o(I, u - l)))
							: ((e.sortIndex = a), S(O, e), M || z || ((M = !0), r(D))),
						e
					);
				}),
...
//# sourceMappingURL=2.5c84b6fa.chunk.js.map
